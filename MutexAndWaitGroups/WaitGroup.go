// A WaitGroup waits for a collections of goroutines to finish.
package main
...
func fetchURL(url string, wg *sync.WaitGroup) {
	...
	// Decrement the WaitGroup counter once the we have fetched the URL
	// After the function finish
	// NOTE: The deferred call's arguments are evaluated immediately,
